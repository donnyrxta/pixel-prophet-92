...
const TrustBand = () => {
  ...
  return (
    <section className="bg-gradient-to-r from-blue-50 via-blue-100 to-blue-50 py-12 border-y-2 border-primary/20">
      <div className="container mx-auto px-4">

        {/* Stats Row - Social Proof */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
          <div className="text-center group hover:scale-105 transition-transform">
            <div className="w-16 h-16 bg-gradient-to-r from-primary to-blue-600 rounded-full flex items-center justify-center mx-auto mb-3 shadow-lg group-hover:shadow-xl">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6">
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <a
              ...
              className="flex items-center gap-4 p-4 hover:bg-blue-50 rounded-lg transition-all group touch-target"
            >
            ...
            <a
              ...
              className="flex items-center gap-4 p-4 hover:bg-blue-50 rounded-lg transition-all group touch-target"
            >
              <div className="w-12 h-12 bg-gradient-to-r from-primary to-blue-600 rounded-full flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
          ...
          <div className="mt-6 pt-6 border-t border-gray-100">
            <div className="flex flex-wrap items-center justify-center gap-4 text-sm text-gray-600">
              ...
              <span className="hidden md:inline text-gray-300">|</span>
              <span className="font-medium text-primary">Sun: Closed</span>
            </div>
          </div>
        </div>
