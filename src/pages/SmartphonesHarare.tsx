...
const smartphones = products.filter(
  p => p.subcategory === 'Smartphones' || p.categorySlug === 'ict'
);

const SmartphonesHarare = () => {
  ...
  const getWhatsAppMessage = (product: typeof smartphones[0], quantity: number) => {
  ...
  return (
    <>
      <SEOHead
        title="Smartphones in Harare - Bulk Pricing Available | SohoConnect"
        description="Buy smartphones in Harare with competitive bulk pricing. Samsung, iPhone, Tecno, Infinix, Xiaomi, Oppo, Vivo. Free delivery in Harare."
        keywords="smartphones harare, buy phones harare, bulk smartphone pricing, samsung harare, iphone harare"
      />
            ...
            <div className="container mx-auto px-4">
              <div className="text-center max-w-4xl mx-auto">
                <h1 className="text-4xl md:text-5xl font-bold mb-4">
                  Smartphones in Harare
                </h1>
                <p className="text-xl text-blue-100 mb-8">
                  Premium smartphones with competitive pricing and bulk discounts.
                  Free delivery in Harare, nationwide shipping available.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <a
                    href="https://wa.me/263771234567?text=Hi%20SohoConnect!%20I%20need%20information%20about%20smartphones."
                    target="_blank"
          ...
          <section className="py-16">
            <div className="container mx-auto px-4">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold mb-4">Available Smartphones</h2>
                <p className="text-xl text-gray-600">Choose from our selection of premium smartphones</p>
              </div>
          ...
          <section className="py-16 bg-blue-600">
            <div className="container mx-auto px-4 text-center">
              ...
              <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
                ...
                We're here to help you find the perfect smartphones for your needs.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                ...
                <a
                  href="https://wa.me/263771234567?text=Hi%20SohoConnect!%20I%20need%20a%20quote%20for%20smartphones."
                  target="_blank"
                  rel="noopener noreferrer"
...
export default SmartphonesHarare;
